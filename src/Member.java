...
class Member implements Serializable {
    ...
    public void setAppliedJobCodeIntoNull(int index) {
        this.appliedJobCode[index] = null;
    }
    ...
    public String getAllMember() {
        return "이름 : " + name + ", 이메일주소 : " + emailAddress + ", 비밀번호 : " + passWord + ", 전화번호 : " + phoneNumber + " 생년월일 : " + birthDate;
    }
